...
{
    //FragmentOfAnArbiterExtraBinah
    public class PassiveAbility_ModPack21341Init6 : PassiveAbilityBase
    {
        ...
        {
            if (!owner.passiveDetail.HasPassive<PassiveAbility_ModPack21341Init5>() &&
                !owner.passiveDetail.HasPassive<PassiveAbility_10010>()) owner.passiveDetail.DestroyPassive(this);
